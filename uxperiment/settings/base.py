...
STATIC_ROOT = os.path.abspath(ROOT_DIR, 'uxperiment', 'static')
...
SECRET_KEY = '*fr+l+y)z_91w6mt9fzdk!0ao9v91l0wjf!rgt%mo&amp;&amp;9s0l6pd'
...
WSGI_APPLICATION = 'uxperiment.wsgi.application'
